...
![Midnight Obsidian Theme](https://raw.githubusercontent.com/codemonkx/Dotfiles/main/.config/Wallpaper/Space.jpg)
...
* **Static Glass Notifications:** Premium glassmorphic notifications with zero hover animations or colors shifting for a clean, stable UI.
...
* **Notification Daemon:** SwayNC (Frosted glass look)
...
Setting up your system from a clean Arch Linux installation:
...
2. **Clone the repository:**
   ```bash
   git clone https://github.com/codemonkx/Dotfiles.git ~/Dotfiles
   ```

3. **Run the automatic installer script:**
   ```bash
   cd ~/Dotfiles
   chmod +x install.sh
   ./install.sh
